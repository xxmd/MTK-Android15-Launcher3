...
public final class RecentsViewStateController extends
    ...
    private void handleSplitSelectionState(@NonNull LauncherState toState,
		...
		Log.d("tl-0102","debugxx enableSplitContextual() = " + enableSplitContextual() + "  toState = " + toState + "  mLauncher.isSplitSelectionActive() = " + mLauncher.isSplitSelectionActive());
        if (toState != OVERVIEW_SPLIT_SELECT && !goingToOverviewFromWorkspaceContextual) {
            // Not going to split
			Log.d("tl-0102","debugxx handleSplitSelectionState return");
            return;
        }
		long startTime = System.currentTimeMillis();
        Log.d("tl-0102","debugxx startTime = " + startTime + "  mClickTime = " + mClickTime  + "  diff = " + (mClickTime - startTime));
        // start add
    if(startTime - mClickTime < 1000){       
            Log.d("tl-0102","debugxx createInitialSplitSelectAnimation return");
            mClickTime = startTime;
            return;
        }
        mClickTime = startTime;
        // end add 
