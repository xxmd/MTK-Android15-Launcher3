...
public class OverviewActionsView<T extends OverlayUICallbacks> extends FrameLayout
    ...
    private void updateForIsTablet() {
        ...
        boolean enabled = !mDp.isTablet;
        if (android.os.SystemProperties.getInt("ro.wb.enable_switch_navbar", 0) == 1) {
        	if (android.provider.Settings.System.getInt(getContext().getContentResolver(), "navigation_style", 0) == 1) {
                enabled = false;
            }
        }
        updateSplitButtonHiddenFlags(FLAG_SMALL_SCREEN_HIDE_SPLIT, enabled);
        // &&}}
        updateActionButtonsVisibility();
    }
    ...
    private void updateActionButtonsVisibility() {
        ...
        if (android.os.SystemProperties.getInt("ro.wb.enable_switch_navbar", 0) == 1) {
        	if (android.provider.Settings.System.getInt(getContext().getContentResolver(), "navigation_style", 0) == 1) {
                showGroupActions = mIsGroupedTask && mCanSaveAppPair;
            }
        }
        // &&}}
