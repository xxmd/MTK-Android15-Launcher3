...
public class LoaderTask implements Runnable {
    ...
    private void loadWorkspaceImpl(
        ...
        // Add Launcher3 Style Switch add by qty {{&&
        if (android.os.SystemProperties.getBoolean("ro.wb.launcher_style_switch",false)) {
            if (android.provider.Settings.System.getInt(context.getContentResolver(), "launcher_style_change", 0) == 1) {
                dbController.createEmptyDB();
                android.provider.Settings.System.putInt(context.getContentResolver(), "launcher_style_change", 0);
            }
        }
        // &&}}
    ...
    private List<LauncherActivityInfo> loadAllApps() {
        ...
        for (UserHandle user : profiles) {
            ...
            for (int i = 0; i < apps.size(); i++) {
                ...
                if (app.getComponentName().getPackageName().equals("com.android.documentsui")){
                continue;
                }
